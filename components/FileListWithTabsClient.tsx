...
import { FileListWithTabs } from "./FileListWithTabs";
import { StepUpDialog } from "./StepUpDialog";

export function FileListWithTabsClient() {
  ...
  const handleRemoveSharedFile = async (shareId: string) => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.message || "Failed to remove shared file");
      }
      ...
      alert(
        error instanceof Error ? error.message : "Failed to remove shared file",
      );
    }
  };
  ...
  return (
    <>
      ...
      <FileListWithTabs
        ...
        onRemoveSharedFile={handleRemoveSharedFile}
